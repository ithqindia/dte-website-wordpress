 ...
 */
class ET_Widget_Price_Filter extends WC_Widget {
	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_price_filter etheme-price-filter';
		$this->widget_description = esc_html__( 'Display a slider to filter products in your store by price.', 'woocommerce' );
	...
	public function widget( $args, $instance ) {
		...
		$ajax_filters = etheme_get_option('ajax_product_filter');
