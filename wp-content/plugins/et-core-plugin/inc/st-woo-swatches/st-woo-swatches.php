	...
	public function cart_swatch_html( $data, $attribute_type, $term_id, $term_name ) {
		...
		switch ( $attribute_type ) {
			...
			case 'st-color-swatch':
				$color  = get_woocommerce_term_meta( $term_id, 'st-color-swatch', true );
			...
			case 'st-label-swatch':
				$label  = get_woocommerce_term_meta( $term_id, 'st-label-swatch', true );
			...
			case 'st-image-swatch':
				$image  = get_woocommerce_term_meta( $term_id, 'st-image-swatch', true );
