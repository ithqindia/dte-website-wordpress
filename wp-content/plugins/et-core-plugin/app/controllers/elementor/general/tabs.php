    ...
    protected function _register_controls() {
    	...
    	$this->add_responsive_control(
    		...
    		[
    			...
    			'selectors' => [
    				'{{WRAPPER}} .et-advance-tabs .et-tabs-nav > ul li:not(:last-child)' => 'margin-right: {{SIZE}}{{UNIT}};',
    			],
                'conditions' => [
                    'terms'  => [
                        [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .et-advance-tabs.et-tabs-vertical .et-tabs-nav > ul li' => 'padding-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .et-advance-tabs.et-tabs-vertical .et-tabs-nav > ul li' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
                'condition' => ['et_tab_layout' => 'et-tabs-vertical'],
            ]
        );
