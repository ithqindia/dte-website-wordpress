...
$columns = ( $ajax ) ? json_decode($ajax['product_single_elements'], true) : json_decode( Kirki::get_option( 'product_single_elements' ), true );



// $columns = json_decode( Kirki::get_option( 'product_single_elements' ), true );
...
$blocks = ( $ajax ) ? json_decode($ajax['connect_block_product_single_package'], true) : Kirki::get_option( 'connect_block_product_single_package' );

// $blocks = Kirki::get_option( 'connect_block_product_single_package' );
    ...
    <div class="et_header-head align-center flex valign-center equal-columns">
        <div class="flex-left align-left">
            ...
            <span class="et_button et_call-multiple-single-products">
                ...
                <span><?php esc_html_e( 'Multiple Templates', 'xstore-core' ); ?></span>
            </span>
        </div>
