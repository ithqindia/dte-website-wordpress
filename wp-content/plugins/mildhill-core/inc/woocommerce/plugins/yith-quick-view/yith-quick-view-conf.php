...
add_action( 'yith_wcqv_product_image', 'mildhill_core_add_product_single_image_holder', 5 );
add_action( 'yith_wcqv_product_image', 'mildhill_core_add_out_of_stock_mark_on_product', 10 );
add_action( 'yith_wcqv_product_image', 'mildhill_core_add_new_mark_on_product', 10 );
add_action( 'yith_wcqv_product_image', 'mildhill_core_add_product_single_image_holder_end', 20 );
...
add_action( 'yith_wcqv_product_summary', 'mildhill_core_woo_template_single_title', 5 );

// Remove meta
remove_action( 'yith_wcqv_product_summary', 'woocommerce_template_single_meta', 30 );

// Add wishlist
add_action( 'yith_wcqv_product_summary', 'mildhill_core_woo_get_yith_wishlist_shortcode', 30 );
