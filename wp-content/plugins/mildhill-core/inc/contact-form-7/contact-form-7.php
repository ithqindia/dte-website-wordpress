...
if ( ! class_exists( 'MildhillCoreContactForm7' ) ) {
	class MildhillCoreContactForm7 {
		...
		function include_widgets() {
			foreach ( glob( MILDHILL_CORE_INC_PATH . '/contact-form-7/widgets/*/include.php' ) as $widget ) {
				include_once $widget;
			}
		}
		...
		function override_templates() {
			...
			add_action( 'wpcf7_init', 'mildhill_core_cf7_add_submit_form_tag' );
		}
	}
	
	MildhillCoreContactForm7::get_instance();
}