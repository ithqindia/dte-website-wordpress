...
if ( ! function_exists( 'mildhill_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function mildhill_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'MildhillCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'mildhill_core_filter_register_shortcodes', 'mildhill_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'MildhillCoreListShortcode' ) ) {
	class MildhillCoreTwitterListShortcode extends MildhillCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( MILDHILL_CORE_INC_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'mildhill_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'mildhill-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'mildhill-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'mildhill-core' ),
				'group'      => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'mildhill-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'mildhill-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'mildhill-core' ),
				'options'       => mildhill_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'mildhill-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return mildhill_core_get_template_part( 'twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
