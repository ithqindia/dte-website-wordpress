...
if ( ! class_exists( 'MildhillCoreRootMainMenuWalker' ) ) {
	class MildhillCoreRootMainMenuWalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			if ( $depth == 0 ) {
				...
				$inner_classes = apply_filters( 'mildhill_core_filter_drop_down_second_inner_classes', array( 'qodef-drop-down-second-inner' ) );
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$menu_appearance = mildhill_core_get_option_value( 'nav-menu', 'qodef-menu-item-appearance', '', $item->ID );
			$menu_icon_pack  = mildhill_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack', '', $item->ID );
			$menu_icon       = mildhill_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack-icon', '', $item->ID );
