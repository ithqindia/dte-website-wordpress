...
if ( ! function_exists( 'mildhill_core_add_centered_header_meta' ) ) {
	function mildhill_core_add_centered_header_meta( $page ) {
	...
	add_action( 'mildhill_core_action_after_page_header_meta_map', 'mildhill_core_add_centered_header_meta' );
}