...
if ( ! function_exists( 'mildhill_core_set_page_content_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function mildhill_core_set_page_content_styles( $style ) {
		$styles = array();
		
		$content_margin = apply_filters( 'mildhill_core_filter_content_margin', 0 );
		...
		$style_mobile = array();
		$content_margin_mobile = apply_filters( 'mildhill_core_filter_content_margin_mobile', 0 );
	...
	add_filter( 'mildhill_filter_add_inline_style', 'mildhill_core_set_page_content_styles' );
}