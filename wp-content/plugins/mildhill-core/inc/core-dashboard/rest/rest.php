...
if ( ! class_exists( 'MildhillCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class MildhillCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'mildhill-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'mildhill_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	MildhillCoreDashboardRestAPI::get_instance();
}