...
if ( ! function_exists( 'mildhill_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function mildhill_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'mildhill-core' ),
					'description' => esc_html__( 'Set values for Heading 6 html element', 'mildhill-core' )
				)
			);
	...
	add_action( 'mildhill_core_action_after_typography_options_map', 'mildhill_core_add_h6_typography_options' );
}