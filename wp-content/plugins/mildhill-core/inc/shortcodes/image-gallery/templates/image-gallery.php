		...
		if ( ! empty( $images ) ) {
			foreach ( $images as $image ) {
				...
				if ( $masonry_images_proportion === 'fixed' ) {
					$image_size_meta = mildhill_core_get_custom_image_size_meta( 'attachment', 'qodef_image_gallery_masonry_size', $image['image_id'] );
				...
				mildhill_core_template_part( 'shortcodes/image-gallery', 'templates/parts/image', '', $image );
			}
		}
		?>
    </div>
