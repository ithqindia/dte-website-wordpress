...
if ( ! function_exists( 'mildhill_core_add_custom_font_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function mildhill_core_add_custom_font_shortcode( $shortcodes ) {
		$shortcodes[] = 'MildhillCoreCustomFontShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'mildhill_core_filter_register_shortcodes', 'mildhill_core_add_custom_font_shortcode' );
}

if ( class_exists( 'MildhillCoreShortcode' ) ) {
	class MildhillCoreCustomFontShortcode extends MildhillCoreShortcode {
		
		public function __construct() {
			$this->set_layouts( apply_filters( 'mildhill_core_filter_custom_font_layouts', array() ) );
			
			parent::__construct();
		}
		
		public function map_shortcode() {
			$this->set_shortcode_path( MILDHILL_CORE_SHORTCODES_URL_PATH . '/custom-font' );
			$this->set_base( 'mildhill_core_custom_font' );
			$this->set_name( esc_html__( 'Custom Font', 'mildhill-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays custom font with provided parameters', 'mildhill-core' ) );
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'title',
				'title'      => esc_html__( 'Title Text', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'title_tag',
				...
				'default_value' => 'p',
				'group'         => esc_html__( 'Typography', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
				'name'       => 'color',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_1366',
				'title'       => esc_html__( 'Font Size', 'mildhill-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 1366', 'mildhill-core' ),
				'group'       => esc_html__( 'Screen Size 1366', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_1024',
				'title'       => esc_html__( 'Font Size', 'mildhill-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 1024', 'mildhill-core' ),
				'group'       => esc_html__( 'Screen Size 1024', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_768',
				'title'       => esc_html__( 'Font Size', 'mildhill-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 768', 'mildhill-core' ),
				'group'       => esc_html__( 'Screen Size 768', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_680',
				'title'       => esc_html__( 'Font Size', 'mildhill-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 680', 'mildhill-core' ),
				'group'       => esc_html__( 'Screen Size 680', 'mildhill-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
		...
		public function render( $options, $content = null ) {
			...
			return mildhill_core_get_template_part( 'shortcodes/custom-font', 'variations/'.$atts['layout'].'/templates/custom-font', '', $atts );
		}
		...
		private function set_responsive_styles( $atts ) {
			...
			foreach ( $screen_sizes as $screen_size ) {
				...
				if ( ! empty( $styles ) ) {
					add_filter( 'mildhill_core_filter_add_responsive_' . $screen_size . '_inline_style_in_footer', function ( $style ) use ( $unique_class, $styles ) {
