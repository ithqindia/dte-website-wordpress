...
if ( ! function_exists( 'mildhill_core_add_linear_icons_to_collection' ) ) {
	function mildhill_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'MildhillCoreLinearIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'mildhill_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MildhillCoreLinearIconsPack extends QodeFrameworkIconPack {
