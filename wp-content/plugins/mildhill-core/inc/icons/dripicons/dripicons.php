...
if ( ! function_exists( 'mildhill_core_add_dripicons_to_collection' ) ) {
	function mildhill_core_add_dripicon_to_collection( $icons ) {
		$icons[] = 'MildhillCoreDripiconsIconPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'mildhill_core_add_dripicon_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MildhillCoreDripiconsIconPack extends QodeFrameworkIconPack {
