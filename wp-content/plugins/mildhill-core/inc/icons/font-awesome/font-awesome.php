...
if ( ! function_exists( 'mildhill_core_add_font_awesome_to_collection' ) ) {
	function mildhill_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'MildhillCoreFontAwesomePack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'mildhill_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MildhillCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return MILDHILL_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
