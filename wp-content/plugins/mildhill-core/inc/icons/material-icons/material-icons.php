...
if ( ! function_exists( 'mildhill_core_add_material_icons_to_collection' ) ) {
	function mildhill_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'MildhillCoreMaterialIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'mildhill_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MildhillCoreMaterialIconsPack extends QodeFrameworkIconPack {
