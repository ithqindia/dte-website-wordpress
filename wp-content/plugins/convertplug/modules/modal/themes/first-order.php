	...
	function modal_theme_first_order( $atts, $content = null ) {
		...
		<div class="cp-row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-text-container">
				...
				?>
					">
					<h2 class="cp-title cp_responsive" ><?php echo do_shortcode( html_entity_decode( stripcslashes( $a['modal_title1'] ), ENT_QUOTES, 'utf-8' ) ); ?></h2>
				</div>
				...
				?>
					">
					<div class="cp-short-description cp_responsive cp-clear " ><?php echo do_shortcode( html_entity_decode( stripcslashes( $a['modal_content'] ), ENT_QUOTES, 'utf-8' ) ); ?></div>
				</div>
				...
				?>
					" >
					<?php echo do_shortcode( html_entity_decode( stripcslashes( $a['modal_confidential'] ), ENT_QUOTES, 'utf-8' ) ); ?>
				</div>
			</div>
		</div>
		<!-- AFTER CONTENTS -->
