...
if ( function_exists( 'smile_update_settings' ) ) {
	...
	$close_link = array(
		...
		array(
			...
			'opts'         => array(
				'title'        => __( 'Close Image Height', 'smile' ),
				'css_selector' => '.cp-overlay-close',
				'css_property' => 'height',
				'value'        => 32,
				'min'          => 15,
...
if ( function_exists( 'smile_update_default' ) ) {
	...
	foreach ( $blank_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'blank', $option, $value );
	}
	...
	foreach ( $optin_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'YouTube', $option, $value );
	}
	...
	foreach ( $optin_to_win_defaults as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'optin_to_win', $option, $value );
	}
	...
	foreach ( $webinar_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'webinar', $option, $value );
	}
	...
	foreach ( $every_design_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'every_design', $option, $value );
	}
	...
	foreach ( $flat_discount_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'flat_discount', $option, $value );
	}
	...
	foreach ( $special_offer_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'special_offer', $option, $value );
	}
	...
	foreach ( $first_order_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'first_order', $option, $value );
	}
	...
	foreach ( $locked_content_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'locked_content', $option, $value );
	}
	...
	foreach ( $first_order_2_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'first_order_2', $option, $value );
	}
	...
	foreach ( $direct_download_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'direct_download', $option, $value );
	}
	...
	foreach ( $instant_coupon_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'instant_coupon', $option, $value );
	}
	...
	foreach ( $free_ebook_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'free_ebook', $option, $value );
	}
	...
	foreach ( $count_down_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'countdown', $option, $value );
	}
	...
	foreach ( $cp_social_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'social_media', $option, $value );
	}
	...
	foreach ( $jugaad_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'jugaad', $option, $value );
	}
	...
	foreach ( $cp_social_inline_share_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'social_inline_share', $option, $value );
	}

	// social_widget_box.
	$social_widget_box_default = array(
		'box_shadow'            => '',
		'modal_title1'          => __( 'STAY IN TOUCH', 'smile' ),
		'border'                => 'br_all:0|br_tl:0|br_tr:0|br_br:0|br_bl:0|style:none|color:rgb(0,0,0)|bw_all:5|bw_t:5|bw_l:5|bw_r:5|bw_b:5',
		'cp_modal_width'        => '350',
	...
	foreach ( $social_widget_box_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'social_widget_box', $option, $value );
	}


	// social_article.
	$social_article_default = array(
		'modal_title1'                => __( 'Enjoyed this article? Please spread the word.', 'smile' ),
		'border'                      => 'br_all:0|br_tl:0|br_tr:0|br_br:0|br_bl:0|style:none|color:rgb(0,0,0)|bw_all:5|bw_t:5|bw_l:5|bw_r:5|bw_b:5',
		'cp_modal_width'              => '550',
	...
	foreach ( $social_article_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'social_article', $option, $value );
	}
	...
	foreach ( $social_media_with_form_default as $option => $value ) {
		smile_update_default( 'Convert_Plug_Smile_Modals', 'social_media_with_form', $option, $value );
	}
}
...
if ( function_exists( 'smile_update_partial' ) ) {
	...
	foreach ( $flat_discount_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'flat_discount', $option, $parse_array );
	}
	...
	foreach ( $webinar_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'webinar', $option, $parse_array );
	}
	...
	foreach ( $special_offer_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'special_offer', $option, $parse_array );
	}
	...
	foreach ( $youtube_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'YouTube', $option, $parse_array );
	}
	...
	foreach ( $count_down_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'countdown', $option, $parse_array );
	}
	...
	foreach ( $social_media_with_form_partial as $option => $parse_array ) {
		smile_update_partial( 'Convert_Plug_Smile_Modals', 'social_media_with_form', $option, $parse_array );
	}
}
