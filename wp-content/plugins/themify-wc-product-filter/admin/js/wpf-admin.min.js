...
d+'</div></div></div><div class="wpf_overlay"></div>';a("body").append(d);m||(m=100);h&&a("#"+k).addClass(h);a.event.trigger("WPF.openlightbox",[b,k]);a("#"+k).nextAll(".wpf_overlay").show();a("#"+k).show().css("top",l()).animate({top:m},800);a("#"+k).find(".wpf_close_lightbox").click(f);h=a("#wpf-import-btn");h.length&&wpf_import(h)}}})}).on("click",".wpf_delete",function(b){if(confirm(wpf_js.template_delete)){var c=a(this),d=c.closest("table");a.ajax({url:this,dataType:"json",beforeSend:function(){d.addClass("wpf_save")},
