...
class Iconic_WooThumbs {
	...
	public function is_enabled( $post_id = null ) {
		...
		return get_post_meta( $post_id, 'disable_woothumbs', true ) !== 'yes';
	}
	...
	public function admin_scripts() {
		...
		if (
			...
			( ! empty( $_GET['page'] ) && ( $_GET['page'] == "iconic-woothumbs-settings-account" || $_GET['page'] == "iconic-woothumbs-settings" ) )
		) {
