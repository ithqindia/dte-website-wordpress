...
if ( ! class_exists( 'Iconic_WooThumbs_Settings_Framework' ) ) {
	/**
	 * Iconic_WooThumbs_Settings_Framework class
	 */
	class Iconic_WooThumbs_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_WooThumbs_Settings_Framework constructor.
		 *
